...
descriptions <- list(
  ...
  "ADM_RATE" =  "The admission rate. This is the number of undergraduate applicants who are offerred admission divided by the total number of undergraduates who applied in the Fall. Reported as a precentage ([0-1])",
