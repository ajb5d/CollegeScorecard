...
The Box-Cox plot (@fig-boxcox) indicates a $\lambda$ somewhat near 0. Because of that and to aid in interpretation we will use try using the log transformation.
