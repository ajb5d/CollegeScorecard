...
It looks like the residuals do have some correlation with eachother as at a few different lags the autocorrelation is significant. It looks like this could possibly be because the data has been sorted by the School's names.
...
For the most part the residuals look to follow the normal distribution, at the lower end there is some deviation.
...
Based on both the Adjusted $R^2$ and AIC metrics the recommended model is considered the best model out of the ones we have tested.
